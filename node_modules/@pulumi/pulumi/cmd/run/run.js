 ...
 */
function resolveEntrypoint(packageRoot, entrypoint, fallback) {
...
async function run(argv, programStarted, reportLoggedError, isErrorReported) {
    ...
    if (!hasEntrypoint) {
        ...
        if (typeof packageObject.exports === "string") {
            ...
            if (typeof mainExport === "string") {
                ...
                program = resolveEntrypoint(packageRoot, mainExport.default || mainExport.require || mainExport.import, program);
            }
        }
        else {
    ...
    if (typeScript) {
        ...
        const hasLoaders = process.execArgv.find((arg) => arg === "--loader" || arg === "--import" || arg === "--require");
        try {
        ...
        if (isModule &&
            ...
            // https://nodejs.org/api/module.html#moduleregisterspecifier-parenturl-options
            module_1.register("./hooks.js", url.pathToFileURL(__filename), {
                data: options,
            });
        }
        else {
...
${error_1.defaultErrorMessage(err)}`);
        ...
        span.addEvent(`uncaughtError: ${error_1.defaultErrorMessage(err)}`);
